...
export class SocialMediaService {
  async postToTwitter(postId: string, postData: PostData): Promise<string | null> {
    try {
  ...
  async postToLinkedIn(postId: string, postData: PostData): Promise<string | null> {
    try {
  ...
  private formatTwitterPost(postData: PostData): string {
  ...
  private formatLinkedInPost(postData: PostData): string {
    // LinkedIn allows longer posts
    return `${postData.title}\n\n${postData.content}\n\n#Travel #Hotels #Hospitality`;
  }

  private async createTweet(text: string, imageUrl?: string): Promise<string> {
  ...
  private async uploadLinkedInImage(imageUrl: string, accessToken: string): Promise<string> {
    // Download image
  ...
  async publishToAllPlatforms(postId: string, postData: PostData) {
