...
export class ContentAgent {
  ...
  async generateContent(hotel: HotelData): Promise<GeneratedContent> {
  ...
  private async generateText(hotel: HotelData): Promise<{ title: string; content: string }> {
...
Format the response as JSON:
{
  ...
  private async generateImage(hotel: HotelData): Promise<string | undefined> {
    try {
  ...
  private async generateImageDalle(hotel: HotelData): Promise<string | undefined> {
    try {
  ...
  private async generateImageOpenRouter(hotel: HotelData): Promise<string | undefined> {
    try {
